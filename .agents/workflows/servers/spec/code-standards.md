...
- **Single Responsibility Principle (SRP)**: Keep functions and classes small and focused on exactly one responsibility. If a function grows beyond 15-20 lines or mixes concerns, extract a smaller helper method.
