...
The transformer for **Summary of MIDI 1.0 Messages** has generated the structured data in `midi-mcp/data/structured/summary-messages.json` from `data/summary-of-midi-1-0-messages-midi-org.md`.
