# Verify Transformer: Default Control Change Mapping Profile

The transformer for **Default Control Change Mapping Profile** has generated the structured data in `midi-mcp/data/structured/default-cc-mapping-profile.json` from `data/m2-113-um-default-control-change-mapping-profile.md`.
