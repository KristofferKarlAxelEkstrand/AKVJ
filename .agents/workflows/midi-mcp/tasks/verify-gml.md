# Verify Transformer: General MIDI Lite RP-033

The transformer for **General MIDI Lite RP-033** has generated the structured data in `midi-mcp/data/structured/gml.json` from `data/gml-v1.md`.
