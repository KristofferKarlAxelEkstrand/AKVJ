# Verify Transformer: CA-018 File Reference SysEx

The transformer for **CA-018 File Reference SysEx** has generated the structured data in `midi-mcp/data/structured/ca18-file-reference.json` from `data/ca18.md`.
