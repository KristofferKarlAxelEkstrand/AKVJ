# Verify Transformer: SysEx ID Table

The transformer for **SysEx ID Table** has generated the structured data in `midi-mcp/data/structured/syex-id-table.json` from `data/sysex-id-table-midi-org.md`.
