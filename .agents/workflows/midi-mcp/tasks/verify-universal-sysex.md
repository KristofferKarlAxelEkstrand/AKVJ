# Verify Transformer: Universal SysEx Messages

The transformer for **Universal SysEx Messages** has generated the structured data in `midi-mcp/data/structured/universal-sysex.json` from `universal-system-exclusive-messages.md`.
