# Verify Transformer: RP-023 Renaming of CC91 and CC93

The transformer for **RP-023 Renaming of CC91 and CC93** has generated the structured data in `midi-mcp/data/structured/rp23.json` from `data/rp23.md`.
