# Verify Transformer: CA-028 Extension 00-01 to File Reference SysEx

The transformer for **CA-028 Extension 00-01 to File Reference SysEx** has generated the structured data in `midi-mcp/data/structured/ca28-extension-file-reference.json` from `data/ca28.md`.
