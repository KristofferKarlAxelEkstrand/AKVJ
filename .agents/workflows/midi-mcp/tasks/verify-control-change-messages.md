# Verify Transformer: MIDI 1.0 Control Change Messages

The transformer for **MIDI 1.0 Control Change Messages** has generated the structured data in `midi-mcp/data/structured/control-change-messages.json` from `data/midi-1-0-control-change-messages-data-bytes-midi-org.md`.
