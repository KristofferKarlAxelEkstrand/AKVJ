# Verify Transformer: CA-024 Global Parameter Control

The transformer for **CA-024 Global Parameter Control** has generated the structured data in `midi-mcp/data/structured/ca24-global-parameter-control.json` from `data/ca24-global-parameter-control-sysex-message.md`.
