# Verify Transformer: GM2 Single Channel Profile M2-119-UM

The transformer for **GM2 Single Channel Profile M2-119-UM** has generated the structured data in `midi-mcp/data/structured/gm2-single-channel-profile.json` from `data/m2-119-um-general-midi-2-single-channel-profile.md`.
