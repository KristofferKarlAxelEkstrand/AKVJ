# Verify Transformer: MMC RP-013

The transformer for **MMC RP-013** has generated the structured data in `midi-mcp/data/structured/mmc.json` from `data/rp-013-v1-0-midi-machine-control-specification-96-1-4.md`.
