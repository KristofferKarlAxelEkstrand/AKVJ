# Verify Transformer: DLS Level 1 Specification

The transformer for **DLS Level 1 Specification** has generated the structured data in `midi-mcp/data/structured/dls1.json` from `data/dls1v11b.md`.
