# Verify Transformer: Key-Based Instrument Controllers overview

The transformer for **Key-Based Instrument Controllers overview** has generated the structured data in `midi-mcp/data/structured/key-based-instrument-controllers-midi-org.json` from `data/key-based-instrument-controllers-midi-org.md`.
