# Verify Transformer: MPE Profile M2-120-UM

The transformer for **MPE Profile M2-120-UM** has generated the structured data in `midi-mcp/data/structured/mpe-profile.json` from `data/m2-120-um-midi-polyphonic-expression-profile.md`.
