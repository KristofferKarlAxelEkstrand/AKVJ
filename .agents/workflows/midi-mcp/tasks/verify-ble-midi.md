# Verify Transformer: BLE-MIDI RP-052

The transformer for **BLE-MIDI RP-052** has generated the structured data in `midi-mcp/data/structured/ble-midi.json` from `data/ble-midi-specification.md`.
