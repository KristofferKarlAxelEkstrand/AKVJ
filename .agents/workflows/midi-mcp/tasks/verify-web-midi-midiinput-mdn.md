# Verify Transformer: MIDIInput MDN

The transformer for **MIDIInput MDN** has generated the structured data in `midi-mcp/data/structured/web-midi-midiinput-mdn.json` from `data/web-midi-midiinput-mdn.md`.
