# Verify Transformer: MIDIAccess MDN

The transformer for **MIDIAccess MDN** has generated the structured data in `midi-mcp/data/structured/web-midi-midiaccess-mdn.json` from `data/web-midi-midiaccess-mdn.md`.
