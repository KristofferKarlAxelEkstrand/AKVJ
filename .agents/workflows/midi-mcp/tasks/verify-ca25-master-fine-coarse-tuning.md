# Verify Transformer: CA-025 Master Fine/Coarse Tuning

The transformer for **CA-025 Master Fine/Coarse Tuning** has generated the structured data in `midi-mcp/data/structured/ca25-master-fine-coarse-tuning.json` from `data/ca25-master-fine-coarse-tuning-sysex-message.md`.
