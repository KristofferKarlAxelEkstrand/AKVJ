# Verify Transformer: RP-019 SMF Device/Program Name Meta Events

The transformer for **RP-019 SMF Device/Program Name Meta Events** has generated the structured data in `midi-mcp/data/structured/rp19.json` from `data/rp19-smf-device-program-name-meta-events.md`.
