# Verify Transformer: MIDI 1.0 Status Bytes

The transformer for **MIDI 1.0 Status Bytes** has generated the structured data in `midi-mcp/data/structured/status-bytes.json` from `reference/status-bytes.md`.
