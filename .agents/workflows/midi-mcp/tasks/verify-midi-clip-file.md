# Verify Transformer: MIDI Clip File M2-116-U

The transformer for **MIDI Clip File M2-116-U** has generated the structured data in `midi-mcp/data/structured/midi-clip-file.json` from `data/m2-116-u-midi-clip-file-specification.md`.
