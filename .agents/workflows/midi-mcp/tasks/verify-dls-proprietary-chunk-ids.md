# Verify Transformer: DLS Proprietary Chunk IDs

The transformer for **DLS Proprietary Chunk IDs** has generated the structured data in `midi-mcp/data/structured/dls-proprietary-chunk-ids.json` from `data/dls-proprietary-chunk-ids-midi-org.md`.
