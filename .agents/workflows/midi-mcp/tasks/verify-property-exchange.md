# Verify Transformer: Property Exchange M2-103-UM

The transformer for **Property Exchange M2-103-UM** has generated the structured data in `midi-mcp/data/structured/property-exchange.json` from `data/m2-103-um-common-rules-for-midi-ci-property-exchange.md`.
