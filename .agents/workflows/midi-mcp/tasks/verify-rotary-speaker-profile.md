# Verify Transformer: Rotary Speaker Profile M2-122-UM

The transformer for **Rotary Speaker Profile M2-122-UM** has generated the structured data in `midi-mcp/data/structured/rotary-speaker-profile.json` from `data/m2-122-um-rotary-speaker-profile.md`.
