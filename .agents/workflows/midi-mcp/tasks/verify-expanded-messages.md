# Verify Transformer: Expanded MIDI 1.0 Messages List

The transformer for **Expanded MIDI 1.0 Messages List** has generated the structured data in `midi-mcp/data/structured/expanded-messages.json` from `data/expanded-midi-1-0-messages-list-midi-org.md`.
