# Verify Transformer: MIDI Tuning Updated Specification

The transformer for **MIDI Tuning Updated Specification** has generated the structured data in `midi-mcp/data/structured/midi-tuning-updated.json` from `data/midi-tuning-updated-specification.md`.
