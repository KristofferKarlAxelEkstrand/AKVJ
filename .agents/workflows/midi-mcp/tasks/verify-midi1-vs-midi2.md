# Verify Transformer: MIDI 1.0 vs MIDI 2.0 Comparison

The transformer for **MIDI 1.0 vs MIDI 2.0 Comparison** has generated the structured data in `midi-mcp/data/structured/midi1-vs-midi2.json` from `reference/midi1-vs-midi2.md`.
