# Verify Transformer: Note-On Orchestral Articulation Profile M2-123-UM

The transformer for **Note-On Orchestral Articulation Profile M2-123-UM** has generated the structured data in `midi-mcp/data/structured/note-on-orchestral-articulation-profile.json` from `data/m2-123-um-note-on-orchestral-articulation-profile.md`.
