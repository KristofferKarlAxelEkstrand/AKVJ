# Verify Transformer: DLS Level 2.2 Specification

The transformer for **DLS Level 2.2 Specification** has generated the structured data in `midi-mcp/data/structured/dls2.json` from `data/dls2amd2-all-a-pub.md`.
