# Verify Transformer: Standards that Incorporate MIDI

The transformer for **Standards that Incorporate MIDI** has generated the structured data in `midi-mcp/data/structured/standards-that-incorporate-midi.json` from `data/standards-that-incorporate-midi-midi-org.md`.
