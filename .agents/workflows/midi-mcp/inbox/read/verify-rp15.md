# Verify Transformer: RP-015 Response to Reset All Controllers

The transformer for **RP-015 Response to Reset All Controllers** has generated the structured data in `midi-mcp/data/structured/rp15.json` from `data/rp15.md`.
