# Verify Transformer: MIDI.org Specs index page

The transformer for **MIDI.org Specs index page** has generated the structured data in `midi-mcp/data/structured/specs-midi-org.json` from `data/specs-midi-org.md`.
