# Verify Transformer: MIDIOutput MDN

The transformer for **MIDIOutput MDN** has generated the structured data in `midi-mcp/data/structured/web-midi-midioutput-mdn.json` from `data/web-midi-midioutput-mdn.md`.
