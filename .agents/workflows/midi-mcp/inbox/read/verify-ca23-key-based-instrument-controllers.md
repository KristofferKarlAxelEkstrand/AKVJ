# Verify Transformer: CA-023 Key-Based Instrument Controllers

The transformer for **CA-023 Key-Based Instrument Controllers** has generated the structured data in `midi-mcp/data/structured/ca23-key-based-instrument-controllers.json` from `data/ca23-key-based-instrument-controller-sysex-message.md`.
