# Verify Transformer: USB-MIDI 1.0 Device Class

The transformer for **USB-MIDI 1.0 Device Class** has generated the structured data in `midi-mcp/data/structured/usb-midi-1-0.json` from `data/usb-midi-1-0-device-class.md`.
