# Verify Transformer: MIDI 2.0 Bit Scaling and Resolution

The transformer for **MIDI 2.0 Bit Scaling and Resolution** has generated the structured data in `midi-mcp/data/structured/bit-scaling-and-resolution.json` from `data/m2-115-u-midi-2-0-bit-scaling-and-resolution.md`.
