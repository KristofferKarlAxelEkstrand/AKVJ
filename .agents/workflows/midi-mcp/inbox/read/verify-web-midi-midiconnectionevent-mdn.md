# Verify Transformer: MIDIConnectionEvent MDN

The transformer for **MIDIConnectionEvent MDN** has generated the structured data in `midi-mcp/data/structured/web-midi-midiconnectionevent-mdn.json` from `data/web-midi-midiconnectionevent-mdn.md`.
