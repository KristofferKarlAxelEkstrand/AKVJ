# Verify Transformer: USB-MIDI 2.0 Device Class

The transformer for **USB-MIDI 2.0 Device Class** has generated the structured data in `midi-mcp/data/structured/usb-midi-2-0.json` from `data/usb-midi-2-0-device-class.md`.
