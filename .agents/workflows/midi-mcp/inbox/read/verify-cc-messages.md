# Verify Transformer: Control Change Messages

The transformer for **Control Change Messages** has generated the structured data in `midi-mcp/data/structured/cc-messages.json` from `control-change-messages-data-bytes.md`.
