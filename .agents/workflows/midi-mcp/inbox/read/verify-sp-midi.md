# Verify Transformer: SP-MIDI RP-034/RP-035

The transformer for **SP-MIDI RP-034/RP-035** has generated the structured data in `midi-mcp/data/structured/sp-midi.json` from `data/spmidi-all-1-0b.md`.
