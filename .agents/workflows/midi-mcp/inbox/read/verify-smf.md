# Verify Transformer: SMF RP-001

The transformer for **SMF RP-001** has generated the structured data in `midi-mcp/data/structured/smf.json` from `data/rp-001-v1-0-standard-midi-files-specification-96-1-4.md`.
