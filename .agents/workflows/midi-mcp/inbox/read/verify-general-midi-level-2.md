# Verify Transformer: General MIDI Level 2 RP-024

The transformer for **General MIDI Level 2 RP-024** has generated the structured data in `midi-mcp/data/structured/general-midi-level-2.json` from `data/general-midi-level-2-07-2-6-1-2a.md`.
