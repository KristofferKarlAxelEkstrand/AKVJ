# Verify Transformer: UMP/MIDI 2.0 Protocol M2-104-UM

The transformer for **UMP/MIDI 2.0 Protocol M2-104-UM** has generated the structured data in `midi-mcp/data/structured/ump-midi2-protocol.json` from `data/m2-104-um-ump-and-midi-2-0-protocol-specification.md`.
