# Verify Transformer: Mobile Phone Control Message RP-046

The transformer for **Mobile Phone Control Message RP-046** has generated the structured data in `midi-mcp/data/structured/mobile-phone-control.json` from `data/rp46public.md`.
