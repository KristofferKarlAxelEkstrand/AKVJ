# Verify Transformer: MSC RP-002-014

The transformer for **MSC RP-002-014** has generated the structured data in `midi-mcp/data/structured/msc.json` from `data/rp-002-014-v1-1-1-midi-show-control-specification-96-1-4.md`.
