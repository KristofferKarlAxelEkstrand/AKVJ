# Verify Transformer: MTC RP-004-008

The transformer for **MTC RP-004-008** has generated the structured data in `midi-mcp/data/structured/mtc.json` from `data/rp-004-008-v4-2-1-midi-time-code-specification-96-1-4.md`.
