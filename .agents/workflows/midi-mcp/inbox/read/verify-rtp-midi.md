# Verify Transformer: RTP-MIDI RFC 6295

The transformer for **RTP-MIDI RFC 6295** has generated the structured data in `midi-mcp/data/structured/rtp-midi.json` from `data/rfc6295-rtp-midi.md`.
