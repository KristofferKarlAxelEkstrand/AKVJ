# Verify Transformer: RP-032 XMF Patch Type Prefix Meta-Event

The transformer for **RP-032 XMF Patch Type Prefix Meta-Event** has generated the structured data in `midi-mcp/data/structured/rp32.json` from `data/rp32-xmf-patch-prefix-meta-event.md`.
