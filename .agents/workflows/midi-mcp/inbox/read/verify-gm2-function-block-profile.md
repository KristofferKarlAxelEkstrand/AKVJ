# Verify Transformer: GM2 Function Block Profile M2-118-UM

The transformer for **GM2 Function Block Profile M2-118-UM** has generated the structured data in `midi-mcp/data/structured/gm2-function-block-profile.json` from `data/m2-118-um-general-midi-2-function-block-profile.md`.
