# Verify Transformer: Global Parameter Control overview

The transformer for **Global Parameter Control overview** has generated the structured data in `midi-mcp/data/structured/global-parameter-control-midi-org.json` from `data/global-parameter-control-midi-org.md`.
