# Verify Transformer: RP-017 SMF Lyric Meta Event Definition

The transformer for **RP-017 SMF Lyric Meta Event Definition** has generated the structured data in `midi-mcp/data/structured/rp17.json` from `data/rp17-smf-lyric-events-definition.md`.
