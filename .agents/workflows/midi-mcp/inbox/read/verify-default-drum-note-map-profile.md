# Verify Transformer: Default Drum Note Map Profile

The transformer for **Default Drum Note Map Profile** has generated the structured data in `midi-mcp/data/structured/default-drum-note-map-profile.json` from `data/m2-125-um-default-drum-note-map-profile.md`.
