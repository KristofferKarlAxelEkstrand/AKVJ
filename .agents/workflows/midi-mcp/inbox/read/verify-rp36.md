# Verify Transformer: RP-036 Default Pan Formula

The transformer for **RP-036 Default Pan Formula** has generated the structured data in `midi-mcp/data/structured/rp36.json` from `data/rp36.md`.
