# Verify Transformer: CA-026 Modulation Depth Range RPN

The transformer for **CA-026 Modulation Depth Range RPN** has generated the structured data in `midi-mcp/data/structured/ca26.json` from `data/ca26-rpn05-modulation-depth-range.md`.
