# Verify Transformer: RP-022 Redefinition of RPN 01/02

The transformer for **RP-022 Redefinition of RPN 01/02** has generated the structured data in `midi-mcp/data/structured/rp22.json` from `data/rp22.md`.
