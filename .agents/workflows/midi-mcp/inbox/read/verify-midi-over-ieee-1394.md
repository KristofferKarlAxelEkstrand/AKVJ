# Verify Transformer: MIDI over IEEE-1394 RP-027

The transformer for **MIDI over IEEE-1394 RP-027** has generated the structured data in `midi-mcp/data/structured/midi-over-ieee-1394.json` from `data/rp27v10-spec.md`.
