# Verify Transformer: MIDI-CI M2-101-UM

The transformer for **MIDI-CI M2-101-UM** has generated the structured data in `midi-mcp/data/structured/midi-ci.json` from `data/m2-101-um-midi-ci-specification.md`.
