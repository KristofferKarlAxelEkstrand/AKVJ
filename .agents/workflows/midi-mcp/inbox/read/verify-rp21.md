# Verify Transformer: RP-021 Sound Controller Defaults

The transformer for **RP-021 Sound Controller Defaults** has generated the structured data in `midi-mcp/data/structured/rp21.json` from `data/rp21.md`.
