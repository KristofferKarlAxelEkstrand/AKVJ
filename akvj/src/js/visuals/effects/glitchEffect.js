...
export default {
	...
	apply(imageData, effect, _timestamp, effectContext) {
		...
		return applyGlitchDisplacement(pixels, original, width, intensity, glitchMaxDisplacement, glitchPixelProbability);
	},

	type: 'glitch'
};

function applyGlitchDisplacement(pixels, original, width, intensity, glitchMaxDisplacement, glitchPixelProbability) {
