...
export function findVelocityThreshold(velocities, velocity) {
	...
	// Find the highest velocity threshold that doesn't exceed the input velocity
...
/**
 * Resolve the animation clip for a given note and velocity.
 ...
 * @returns {AnimationClip|null} The matching animation clip, or null if none
 * @example
